...
import { CheckIcon, Heart, Shield } from 'lucide-react'
...
const PostDemonstration = () => {
  ...
  const totalCount = POST_DEMONSTRATION_CHECKLIST.items.length
    ...
    <div className="max-w-screen-md mx-auto px-4 md:px-10 pb-10">
      <div className="text-center mb-6">
        ...
        <div className="flex items-center justify-center gap-2 mb-4">
          <Shield className="text-green-400 size-5" />
          <span className="text-green-200 font-medium">
            Status: Demonstrasi Selesai
          </span>
        </div>
      ...
      <div className="mb-6 p-4 bg-green-200 rounded-2xl border-2 border-green-300">
        ...
        <p className="text-green-800 text-sm">
          Partisipasi Anda dalam demonstrasi damai adalah bentuk kontribusi
          nyata untuk demokrasi Indonesia.
        </p>
      </div>
